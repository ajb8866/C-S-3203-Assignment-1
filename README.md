...
Originally created by Daylon Carse and modified by Ji Hwan Park, with some 

additional minor modifactions by Averi Bates 

Due Date: 9/30/2022 by 11:30pm 
...
User ID numbers (not Tweet ID numbers) are randomly generated along with names. Possible future updates may include the implementation of changable names. 
...
To search for a tweet, enter an ID (Tweet ID) and then click on the 'Search' button.
